...
----
	...
	management.metrics.export.humio.connect-timeout=1s # Connection timeout for requests to this backend.
	...
	management.metrics.export.humio.repository=sandbox # Repository to report metrics to.
	management.metrics.export.humio.step=1m # Step size (i.e. reporting frequency) to use.
	management.metrics.export.humio.tags.source=micrometer # Tags that will be appended on all metrics
